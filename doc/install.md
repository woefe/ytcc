...
To be able to generate an RSS feed with `ytcc --output rss list […]`, you must install extra dependencies with:
```shell script
pip install 'ytcc[rss]'
```
...
- [PyRSS2Gen](http://www.dalkescientific.com/Python/PyRSS2Gen.html), if you want to generate RSS feed
